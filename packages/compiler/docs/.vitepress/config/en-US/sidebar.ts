    ...
    items: [
      { text: 'Overview', link: '/en/guide/semantic-comparison/overview' },
      {
        ...
        items: [
          ...
          { text: 'toRef(s)', link: '/en/guide/semantic-comparison/script/to-ref-s' },
          { text: 'watch', link: '/en/guide/semantic-comparison/script/watch' },
          { text: 'watchEffect', link: '/en/guide/semantic-comparison/script/watch-effect' },
          ...
          {
            text: 'withDefaults',
            link: '/en/guide/semantic-comparison/script/with-defaults',
          },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Style Preprocessors', link: '/en/guide/semantic-comparison/style/lang' },
          { text: 'Deep Selector', link: '/guide/semantic-comparison/style/deep-selector' },
        ],
      },
    ],
  },
